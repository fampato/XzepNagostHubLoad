...
local LeftOther = Tabs.Main:AddLeftGroupbox('Other')
...
LeftOther:AddToggle('AutoBoneToggle', {
    Text = 'AutoFarmBone',
    Default = true, -- Default value (true / false)
    Tooltip = 'AutoFarmBone', -- Information shown when you hover over the toggle
})
Toggles.AutoBoneToggle:OnChanged(function(value)
    _G.Auto_Farm_Bone = value    
end)
Toggles.AutoBoneToggle:SetValue(false)
spawn(function()
	...
	while wait() do
		pcall(function()
			if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
				Mob_Kill_Cake_Prince:Set("KillMob : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41).." : More")
			elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
				Mob_Kill_Cake_Prince:Set("KillMob : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40).." : More")
			elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
				Mob_Kill_Cake_Prince:Set("KillMob : "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39).." : More")
			else
				Mob_Kill_Cake_Prince:Set("Boss  Spawned")
			end
		end)
	end
end)
LeftOther:AddToggle('AutokatakurispawmnToggle', {
    Text = 'Spawnkatakuri',
    Default = true, -- Default value (true / false)
    Tooltip = 'Spawnkatakuri', -- Information shown when you hover over the toggle
})
Toggles.AutokatakurispawmnToggle:OnChanged(function(value)
    _G.Auto_Spawn_Cake_Prince = value    
end)
Toggles.AutokatakurispawmnToggle:SetValue(true)
spawn(function()
	while wait() do
...
LeftOther:AddToggle('AutokatakuriToggle', {
    Text = 'AutoCakePrince',
    Default = true, -- Default value (true / false)
    Tooltip = 'AutoCakePrince', -- Information shown when you hover over the toggle
})
Toggles.AutokatakuriToggle:OnChanged(function(value)
    _G.Auto_Cake_Prince = value    
end)
Toggles.AutokatakuriToggle:SetValue(false)
spawn(function()
	game:GetService("RunService").Heartbeat:Connect(function()
		pcall(function()
			for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
